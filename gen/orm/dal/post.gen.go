...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.PID = field.NewInt32(tableName, "pId")
	_post.Username = field.NewString(tableName, "username")
	_post.PTitle = field.NewString(tableName, "pTitle")
	_post.PCenter = field.NewString(tableName, "pCenter")
	_post.PImg = field.NewString(tableName, "pImg")
	_post.PLabel = field.NewString(tableName, "pLabel")
	_post.PTime = field.NewTime(tableName, "pTime")
...
func (p *post) updateTableName(table string) *post {
	...
	p.PTitle = field.NewString(table, "pTitle")
	p.PCenter = field.NewString(table, "pCenter")
	p.PImg = field.NewString(table, "pImg")
	p.PLabel = field.NewString(table, "pLabel")
	p.PTime = field.NewTime(table, "pTime")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["pTitle"] = p.PTitle
	p.fieldMap["pCenter"] = p.PCenter
	p.fieldMap["pImg"] = p.PImg
	p.fieldMap["pLabel"] = p.PLabel
	p.fieldMap["pTime"] = p.PTime
}
